...
'''
Regression tests for test_datastore_attributes validation logic.
'''
import numpy as np
import pytest
from IQM_Vis.ui_wrapper import test_datastore_attributes
...
def test_validates_get_image_to_transform():
    ...
    with pytest.raises(TypeError) as exc_info:
        test_datastore_attributes(bad_ds)
